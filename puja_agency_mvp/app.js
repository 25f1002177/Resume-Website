...
function applyAreaPersonalisation(){
  ...
  const map = {
    gariahat: {
      label:"গড়িয়াহাট",
      headline:"এই পুজোয় গড়িয়াহাটে ক্রেতা কোথায় কেনাকাটা করবেন—সেই সিদ্ধান্তের আগেই আপনার দোকানকে তাঁদের সামনে আনুন"
    },
    newmarket: {
      label:"নিউ মার্কেট",
      headline:"এই পুজোয় নিউ মার্কেটে ক্রেতা কোথায় কেনাকাটা করবেন—সেই সিদ্ধান্তের আগেই আপনার দোকানকে তাঁদের সামনে আনুন"
    },
    hatibagan: {
      label:"হাতিবাগান",
      headline:"এই পুজোয় হাতিবাগানে ক্রেতা কোথায় কেনাকাটা করবেন—সেই সিদ্ধান্তের আগেই আপনার দোকানকে তাঁদের সামনে আনুন"
    }
  };
